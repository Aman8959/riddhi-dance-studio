...
export async function getMedia(_token?: string) { const url = new URL(requireApiUrl()); url.searchParams.set("action", "mediaList"); return readResponse<MediaItem[]>(await fetch(url)); }
