...
export const danceClasses: DanceClass[] = [
  {
    ...
    trainer: "Ajeet Sir",
    description: "Rhythm games, basic technique and mini stage routines that make shy kids shine.",
    price: 700,
    image: kids,
  },
  {
    ...
    trainer: "Ajeet Sir",
    description: "Trending song choreography with expressions, formations and performance polish.",
    price: 1000,
    image: bollywood,
  },
  {
    ...
    description: "Groove foundations, drills and battle-ready freestyle sessions every week.",
    price: 1000,
    image: hiphop,
  },
  {
    ...
    description: "Technique, improvisation and choreography creation for expressive movers.",
    price: 2600,
    image: contemporary,
  },
  {
    id: "advanced-hiphop",
    name: "Advanced Urban Hip-Hop Crew",
    style: "Urban Hip-Hop",
    ageGroup: "14+ years",
    level: "Advanced",
    duration: "90 min",
    timing: "Thu & Sat, 7:30 PM",
    trainer: "Riddhi Shukla & Ajeet Sir",
    description:
      "Complex fast-paced choreography, speed drills, isolation control and stage performance sets for advanced dancers.",
    price: 1800,
    image: hiphop,
  },
  {
    id: "advanced-contemporary",
    name: "Advanced Contemporary Masterclass",
    style: "Contemporary",
    ageGroup: "15+ years",
    level: "Advanced",
    duration: "90 min",
    timing: "Wed & Sun, 6:00 PM",
    trainer: "Riddhi Shukla",
    description:
      "High-intensity floor work, fluid transitions, leaps, turns and expressive stage choreography.",
    price: 2800,
    image: contemporary,
  },
  {
    ...
    timing: "Sat, 9:00 AM",
    trainer: "Riddhi Shukla",
    description: "Graded classical syllabus with adavus, theory and annual arangetram preparation.",
    price: 2500,
    image: classical,
  },
  {
    ...
    trainer: "Riddhi Shukla",
    description: "Morning cardio dance that torches calories with Latin and Bollywood beats.",
    price: 1500,
    image: zumba,
  },
  {
...
export const batches: Batch[] = [
  {
    ...
    day: "Monday",
    time: "5:00 PM",
    className: "Kids Dance Foundation",
    style: "Kids",
    ageGroup: "4–12",
    trainer: "Riddhi Patel",
    level: "Beginner",
  ...
  },
  {
    ...
    day: "Saturday",
    time: "9:00 AM",
    className: "Bharatanatyam Gurukul",
    style: "Classical",
    ageGroup: "6+",
    trainer: "Meera Iyer",
    level: "All Levels",
...
export const videos: VideoItem[] = [
  {
    id: "v1",
    title: "Annual Day — Bollywood Medley",
  ...
  {
    id: "v2",
    title: "Advanced Hip-Hop Crew Choreography",
  ...
  {
    id: "v3",
    title: "Contemporary — 'Kabira' Solo",
  ...
  {
    id: "v4",
    title: "Advanced Bharatanatyam Arangetram Highlights",
    category: "Performances",
    level: "Advanced",
    youtubeId: "dQw4w9WgXcQ",
    thumbnail: classical,
  ...
  {
    id: "v6",
    title: "Sangeet & Wedding Choreography Reel",
    category: "Choreography",
    level: "Beginner",
    youtubeId: "dQw4w9WgXcQ",
    thumbnail: wedding,
  ...
  {
    id: "v7",
    title: "Advanced Contemporary Floorwork & Turns",
    category: "Choreography",
    level: "Advanced",
    youtubeId: "dQw4w9WgXcQ",
    thumbnail: contemporary,
  ...
  {
    id: "v8",
    title: "Kids Beginner Freestyle Routine",
    category: "Classes",
    level: "Beginner",
    youtubeId: "dQw4w9WgXcQ",
    thumbnail: kids,
  ...
  {
    id: "v9",
    title: "Advanced Urban Hip-Hop Cypher & Drills",
    category: "Choreography",
    level: "Advanced",
    youtubeId: "dQw4w9WgXcQ",
    thumbnail: hiphop,
...
export const events: StudioEvent[] = [
  ...
  },
  {
    ...
    instructor: "Riddhi Shukla",
    description: "Grooves, foundations and a freestyle cypher hosted with a visiting Mumbai crew.",
    image: hiphop,
    status: "Few Seats",
  },
  {
    ...
    instructor: "Riddhi Shukla",
    description: "Get festival-ready with traditional and fusion garba steps for the whole family.",
    image: classical,
    status: "Open",
  },
  {
    ...
    description: "Our yearly stage production featuring every batch, from kids to advanced crews.",
    image: competition,
    status: "Open",
  },
];
...
export const specialServices = [
  {
    ...
    description:
      "Customised sangeet sets for couples, families and squads — any song, any skill level.",
  },
  {
    id: "corporate",
